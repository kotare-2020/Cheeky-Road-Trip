            ...
            { auth.isAuthenticated
              ...
              : (
                <>
                  ...
                  <Link onClick={this.toggleBurger} className="navbar-item" to='/lost'>Lost Animals</Link>
                  {auth.isAuthenticated ? <Link onClick={this.toggleBurger} className="navbar-item" to='/home'></Link>  : <></>}
